...
def processar_efeitos_continuos(lista_efeitos, vida_atual, escrever, nome_alvo):
  """Aplica dano de Queimadura/Sangramento/Veneno e decrementa Fraqueza.
  Paralisia é tratada à parte por `verificar_paralisia`, pois ela precisa ser
  resolvida ANTES de decidir se o alvo pode agir neste turno."""
  restantes = []
  for efeito in lista_efeitos:
    nome = efeito['nome']
    if nome == 'Paralisia':
